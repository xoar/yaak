...
if (IsSymb (_currn, SYMBAttrSpec)) return (Mkrule_119(_coordref, _currn));
if (IsSymb (_currn, SYMBChainSpec)) return (Mkrule_120(_coordref, _currn));
if (IsSymb (_currn, SYMBRuleSpec)) return (Mkrule_121(_coordref, _currn));
if (IsSymb (_currn, SYMBSymAttrSpec)) return (Mkrule_124(_coordref, _currn));
if (IsSymb (_currn, SYMBSymCompSpec)) return (Mkrule_125(_coordref, _currn));
if (IsSymb (_currn, SYMBTermSpec)) return (Mkrule_126(_coordref, _currn));
return(NULLNODEPTR);
}/* MkSpec */
...
if (IsSymb (_currn, SYMBSymbolId)) return (Mkrule_117(_coordref, _currn));
if (IsSymb (_currn, SYMBShieldSym)) return (Mkrule_117(_coordref, _currn));
return(NULLNODEPTR);
}/* MkShieldSyms */
...
if (IsSymb (_currn, SYMBRemoteAttr)) return (Mkrule_109(_coordref, _currn));
return(NULLNODEPTR);
}/* MkRemoteAttrs */
...
if (IsSymb (_currn, SYMBParam)) return (Mkrule_105(_coordref, _currn));
if (IsSymb (_currn, SYMBExpressionDep)) return (Mkrule_105(_coordref, _currn));
if (IsSymb (_currn, SYMBAttr)) return (Mkrule_105(_coordref, _currn));
if (IsSymb (_currn, SYMBRhsAttrs)) return (Mkrule_105(_coordref, _currn));
if (IsSymb (_currn, SYMBRemoteExpression)) return (Mkrule_105(_coordref, _currn));
if (IsSymb (_currn, SYMBSymbolRef)) return (Mkrule_105(_coordref, _currn));
if (IsSymb (_currn, SYMBExpression)) return (Mkrule_105(_coordref, _currn));
return(NULLNODEPTR);
}/* MkParams */
...
if (IsSymb (_currn, SYMBInheritSym)) return (Mkrule_100(_coordref, _currn));
if (IsSymb (_currn, SYMBSymbolId)) return (Mkrule_100(_coordref, _currn));
return(NULLNODEPTR);
}/* MkInheritSyms */
...
if (IsSymb (_currn, SYMBSymbolDefId)) return (Mkrule_97(_coordref, _currn));
return(NULLNODEPTR);
}/* MkG1 */
...
if (IsSymb (_currn, SYMBDepAttr)) return (Mkrule_94(_coordref, _currn));
if (IsSymb (_currn, SYMBAttr)) return (Mkrule_94(_coordref, _currn));
if (IsSymb (_currn, SYMBRhsAttrs)) return (Mkrule_94(_coordref, _currn));
if (IsSymb (_currn, SYMBRemoteExpression)) return (Mkrule_94(_coordref, _currn));
return(NULLNODEPTR);
}/* MkDependence */
...
if (IsSymb (_currn, SYMBDepAttr)) return (Mkrule_90(_coordref, _currn));
...
if (IsSymb (_currn, SYMBAttrDef)) return (Mkrule_72(_coordref, _currn));
return(NULLNODEPTR);
}/* MkAttrDefs */
...
if (IsSymb (_currn, SYMBExpressionDep)) return (Mkrule_102(_coordref, _currn));
if (IsSymb (_currn, SYMBAttr)) return (Mkrule_102(_coordref, _currn));
if (IsSymb (_currn, SYMBRhsAttrs)) return (Mkrule_102(_coordref, _currn));
if (IsSymb (_currn, SYMBRemoteExpression)) return (Mkrule_102(_coordref, _currn));
if (IsSymb (_currn, SYMBSymbolRef)) return (Mkrule_102(_coordref, _currn));
if (IsSymb (_currn, SYMBExpression)) return (Mkrule_102(_coordref, _currn));
return(NULLNODEPTR);
}/* MkParam */
...
if (IsSymb (_currn, SYMBParam)) return (Mkrule_104(_coordref, _currn));
if (IsSymb (_currn, SYMBParams)) return (Mkrule_104(_coordref, _currn));
if (IsSymb (_currn, SYMBExpressionDep)) return (Mkrule_104(_coordref, _currn));
if (IsSymb (_currn, SYMBAttr)) return (Mkrule_104(_coordref, _currn));
if (IsSymb (_currn, SYMBRhsAttrs)) return (Mkrule_104(_coordref, _currn));
if (IsSymb (_currn, SYMBRemoteExpression)) return (Mkrule_104(_coordref, _currn));
if (IsSymb (_currn, SYMBSymbolRef)) return (Mkrule_104(_coordref, _currn));
if (IsSymb (_currn, SYMBExpression)) return (Mkrule_104(_coordref, _currn));
return(NULLNODEPTR);
}/* MkParamsOpt */
...
if (IsSymb (_currn, SYMBRemoteExpression)) return (Mkrule_88(_coordref, _currn));
return(NULLNODEPTR);
}/* MkDepAttr */
...
if (IsSymb (_currn, SYMBRemoteAttr)) return (Mkrule_111(_coordref, _currn));
return(NULLNODEPTR);
}/* MkRemoteClause */
...
if (IsSymb (_currn, SYMBSymbolId)) return (Mkrule_115(_coordref, _currn));
if (IsSymb (_currn, SYMBShieldSym)) return (Mkrule_115(_coordref, _currn));
return(NULLNODEPTR);
}/* MkShieldClause */
...
if (IsSymb (_currn, SYMBLoop)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBAttrComp)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBPlainComp)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBCompute)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBExpressionDep)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBAttr)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBRhsAttrs)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBRemoteExpression)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBSymbolRef)) return (Mkrule_84(_coordref, _currn));
if (IsSymb (_currn, SYMBExpression)) return (Mkrule_84(_coordref, _currn));
return(NULLNODEPTR);
}/* MkComputation */
...
if (IsSymb (_currn, SYMBLoop)) return (Mkrule_108(_coordref, _currn));
if (IsSymb (_currn, SYMBExpressionDep)) return (Mkrule_107(_coordref, _currn));
if (IsSymb (_currn, SYMBAttr)) return (Mkrule_107(_coordref, _currn));
if (IsSymb (_currn, SYMBRhsAttrs)) return (Mkrule_107(_coordref, _currn));
if (IsSymb (_currn, SYMBRemoteExpression)) return (Mkrule_107(_coordref, _currn));
if (IsSymb (_currn, SYMBSymbolRef)) return (Mkrule_107(_coordref, _currn));
if (IsSymb (_currn, SYMBExpression)) return (Mkrule_107(_coordref, _currn));
return(NULLNODEPTR);
}/* MkPlainComp */
...
if (IsSymb (_currn, SYMBChainName)) return (Mkrule_80(_coordref, _currn));
return(NULLNODEPTR);
}/* MkChainNames */
...
if (IsSymb (_currn, SYMBAttrName)) return (Mkrule_77(_coordref, _currn));
return(NULLNODEPTR);
}/* MkAttrNames */
...
if (IsSymb (_currn, SYMBAttrDefId)) return (Mkrule_70(_coordref, _currn));
return(NULLNODEPTR);
}/* MkAttrDefIds */
...
if (IsSymb (_currn, SYMBSyntId)) return (Mkrule_66(_coordref, _currn));
if (IsSymb (_currn, SYMBAlt)) return (Mkrule_66(_coordref, _currn));
return(NULLNODEPTR);
}/* MkAlts */
...
if (IsSymb (_currn, SYMBAttrDef)) return (Mkrule_75(_coordref, _currn));
if (IsSymb (_currn, SYMBAttrDefs)) return (Mkrule_75(_coordref, _currn));
return(NULLNODEPTR);
}/* MkAttrDefsOpt */
...
if (IsSymb (_currn, SYMBSymbolDefId)) return (Mkrule_129(_coordref, _currn));
if (IsSymb (_currn, SYMBG1)) return (Mkrule_129(_coordref, _currn));
return(NULLNODEPTR);
}/* MkSymbolDefIds */
...
if (IsSymb (_currn, SYMBSpecs)) return (Mkrule_64(_coordref, _currn));
return(NULLNODEPTR);
}/* MkAG */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_129 (POSITION *_coordref, NODEPTR _desc1)
#else
NODEPTR Mkrule_129 (_coordref,_desc1)
	POSITION *_coordref;
	NODEPTR _desc1;
#endif
{	_TPPrule_129 _currn;
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_129: root of subtree no. 1 can not be made a G1 node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_129;
return ( (NODEPTR) _currn);
}/* Mkrule_129 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_128 (POSITION *_coordref, int _TERM1)
#else
NODEPTR Mkrule_128 (_coordref, _TERM1)
	POSITION *_coordref;
	int _TERM1;
#endif
{	_TPPrule_128 _currn;
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_126 (POSITION *_coordref, NODEPTR _desc1)
#else
NODEPTR Mkrule_126 (_coordref,_desc1)
	POSITION *_coordref;
	NODEPTR _desc1;
#endif
{	_TPPrule_126 _currn;
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_126: root of subtree no. 1 can not be made a TermSpec node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_126;
return ( (NODEPTR) _currn);
}/* Mkrule_126 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_125: root of subtree no. 1 can not be made a SymCompSpec node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_125;
return ( (NODEPTR) _currn);
}/* Mkrule_125 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_124 (POSITION *_coordref, NODEPTR _desc1)
#else
NODEPTR Mkrule_124 (_coordref,_desc1)
	POSITION *_coordref;
	NODEPTR _desc1;
#endif
{	_TPPrule_124 _currn;
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_124: root of subtree no. 1 can not be made a SymAttrSpec node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_124;
return ( (NODEPTR) _currn);
}/* Mkrule_124 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_123: root of subtree no. 1 can not be made a Specs node ", 0, _coordref);
_currn->_desc2 = (_TSPSpec) MkSpec (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_123: root of subtree no. 2 can not be made a Spec node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_123;
return ( (NODEPTR) _currn);
}/* Mkrule_123 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_121: root of subtree no. 1 can not be made a RuleSpec node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_121;
return ( (NODEPTR) _currn);
}/* Mkrule_121 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_120: root of subtree no. 1 can not be made a ChainSpec node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_120;
return ( (NODEPTR) _currn);
}/* Mkrule_120 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_119: root of subtree no. 1 can not be made a AttrSpec node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_119;
return ( (NODEPTR) _currn);
}/* Mkrule_119 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_118 (POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2)
#else
NODEPTR Mkrule_118 (_coordref,_desc1,_desc2)
	POSITION *_coordref;
	NODEPTR _desc1;
	NODEPTR _desc2;
#endif
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_118: root of subtree no. 1 can not be made a ShieldSyms node ", 0, _coordref);
_currn->_desc2 = (_TSPShieldSym) MkShieldSym (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_118: root of subtree no. 2 can not be made a ShieldSym node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_118;
return ( (NODEPTR) _currn);
}/* Mkrule_118 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_117: root of subtree no. 1 can not be made a ShieldSym node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_117;
return ( (NODEPTR) _currn);
}/* Mkrule_117 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_116 (POSITION *_coordref, NODEPTR _desc1)
#else
NODEPTR Mkrule_116 (_coordref,_desc1)
	POSITION *_coordref;
	NODEPTR _desc1;
#endif
{	_TPPrule_116 _currn;
...
_currn->_desc1 = (_TSPShieldSyms) MkShieldSyms (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_116: root of subtree no. 1 can not be made a ShieldSyms node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_116;
return ( (NODEPTR) _currn);
}/* Mkrule_116 */
...
_currn->_desc1 = (_TSPShieldSym) MkShieldSym (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_115: root of subtree no. 1 can not be made a ShieldSym node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_115;
return ( (NODEPTR) _currn);
}/* Mkrule_115 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_113 (POSITION *_coordref, int _TERM1)
#else
NODEPTR Mkrule_113 (_coordref, _TERM1)
	POSITION *_coordref;
	int _TERM1;
#endif
{	_TPPrule_113 _currn;
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_112: root of subtree no. 1 can not be made a RemoteAttrs node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_112;
return ( (NODEPTR) _currn);
}/* Mkrule_112 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_111: root of subtree no. 1 can not be made a RemoteAttr node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_111;
return ( (NODEPTR) _currn);
}/* Mkrule_111 */
...
_currn->_desc1 = (_TSPRemoteAttr) MkRemoteAttr (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_110: root of subtree no. 1 can not be made a RemoteAttr node ", 0, _coordref);
_currn->_desc2 = (_TSPRemoteAttrs) MkRemoteAttrs (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_110: root of subtree no. 2 can not be made a RemoteAttrs node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_110;
return ( (NODEPTR) _currn);
}/* Mkrule_110 */
...
_currn->_desc1 = (_TSPRemoteAttr) MkRemoteAttr (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_109: root of subtree no. 1 can not be made a RemoteAttr node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_109;
return ( (NODEPTR) _currn);
}/* Mkrule_109 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_108: root of subtree no. 1 can not be made a Loop node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_108;
return ( (NODEPTR) _currn);
}/* Mkrule_108 */
...
_currn->_desc1 = (_TSPExpressionDep) MkExpressionDep (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_107: root of subtree no. 1 can not be made a ExpressionDep node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_107;
return ( (NODEPTR) _currn);
}/* Mkrule_107 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_106 (POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2)
#else
NODEPTR Mkrule_106 (_coordref,_desc1,_desc2)
	POSITION *_coordref;
	NODEPTR _desc1;
	NODEPTR _desc2;
#endif
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_106: root of subtree no. 1 can not be made a Param node ", 0, _coordref);
_currn->_desc2 = (_TSPParams) MkParams (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_106: root of subtree no. 2 can not be made a Params node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_106;
return ( (NODEPTR) _currn);
}/* Mkrule_106 */
...
_currn->_desc1 = (_TSPParam) MkParam (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_105: root of subtree no. 1 can not be made a Param node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_105;
return ( (NODEPTR) _currn);
}/* Mkrule_105 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_104: root of subtree no. 1 can not be made a Params node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_104;
return ( (NODEPTR) _currn);
}/* Mkrule_104 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_103 (POSITION *_coordref)
#else
NODEPTR Mkrule_103 (_coordref)
	POSITION *_coordref;
#endif
{	_TPPrule_103 _currn;
#ifdef __cplusplus
...
_currn->_desc1 = (_TSPExpressionDep) MkExpressionDep (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_102: root of subtree no. 1 can not be made a ExpressionDep node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_102;
return ( (NODEPTR) _currn);
}/* Mkrule_102 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_101: root of subtree no. 1 can not be made a InheritSyms node ", 0, _coordref);
_currn->_desc2 = (_TSPInheritSym) MkInheritSym (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_101: root of subtree no. 2 can not be made a InheritSym node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_101;
return ( (NODEPTR) _currn);
}/* Mkrule_101 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_100: root of subtree no. 1 can not be made a InheritSym node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_100;
return ( (NODEPTR) _currn);
}/* Mkrule_100 */
...
_currn->_desc1 = (_TSPInheritSyms) MkInheritSyms (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_99: root of subtree no. 1 can not be made a InheritSyms node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_99;
return ( (NODEPTR) _currn);
}/* Mkrule_99 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_97: root of subtree no. 1 can not be made a SymbolDefId node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_97;
return ( (NODEPTR) _currn);
}/* Mkrule_97 */
...
_currn->_desc1 = (_TSPG1) MkG1 (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_96: root of subtree no. 1 can not be made a G1 node ", 0, _coordref);
_currn->_desc2 = (_TSPSymbolDefId) MkSymbolDefId (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_96: root of subtree no. 2 can not be made a SymbolDefId node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_96;
return ( (NODEPTR) _currn);
}/* Mkrule_96 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_95 (POSITION *_coordref, NODEPTR _desc1)
#else
NODEPTR Mkrule_95 (_coordref,_desc1)
	POSITION *_coordref;
	NODEPTR _desc1;
#endif
{	_TPPrule_95 _currn;
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_95: root of subtree no. 1 can not be made a DepAttrs node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_95;
return ( (NODEPTR) _currn);
}/* Mkrule_95 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_94: root of subtree no. 1 can not be made a DepAttr node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_94;
return ( (NODEPTR) _currn);
}/* Mkrule_94 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_93: root of subtree no. 1 can not be made a Dependence node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_93;
return ( (NODEPTR) _currn);
}/* Mkrule_93 */
...
_currn->_desc1 = (_TSPDependence) MkDependence (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_92: root of subtree no. 1 can not be made a Dependence node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_92;
return ( (NODEPTR) _currn);
}/* Mkrule_92 */
...
_currn->_desc1 = (_TSPDepAttr) MkDepAttr (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_91: root of subtree no. 1 can not be made a DepAttr node ", 0, _coordref);
_currn->_desc2 = (_TSPDepAttrs) MkDepAttrs (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_91: root of subtree no. 2 can not be made a DepAttrs node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_91;
return ( (NODEPTR) _currn);
}/* Mkrule_91 */
...
_currn->_desc1 = (_TSPDepAttr) MkDepAttr (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_90: root of subtree no. 1 can not be made a DepAttr node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_90;
return ( (NODEPTR) _currn);
}/* Mkrule_90 */
...
_currn->_desc1 = (_TSPRhsAttrs) MkRhsAttrs (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_89: root of subtree no. 1 can not be made a RhsAttrs node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_89;
return ( (NODEPTR) _currn);
}/* Mkrule_89 */
...
_currn->_desc1 = (_TSPRemoteExpression) MkRemoteExpression (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_88: root of subtree no. 1 can not be made a RemoteExpression node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_88;
return ( (NODEPTR) _currn);
}/* Mkrule_88 */
...
_currn->_desc1 = (_TSPAttr) MkAttr (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_87: root of subtree no. 1 can not be made a Attr node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_87;
return ( (NODEPTR) _currn);
}/* Mkrule_87 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_86: root of subtree no. 1 can not be made a Computation node ", 0, _coordref);
_currn->_desc2 = (_TSPComputations) MkComputations (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_86: root of subtree no. 2 can not be made a Computations node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_86;
return ( (NODEPTR) _currn);
}/* Mkrule_86 */
...
_currn->_desc1 = (_TSPCompute) MkCompute (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_84: root of subtree no. 1 can not be made a Compute node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_84;
return ( (NODEPTR) _currn);
}/* Mkrule_84 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_83: root of subtree no. 1 can not be made a Computations node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_83;
return ( (NODEPTR) _currn);
}/* Mkrule_83 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_81 (POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2)
#else
NODEPTR Mkrule_81 (_coordref,_desc1,_desc2)
	POSITION *_coordref;
	NODEPTR _desc1;
	NODEPTR _desc2;
#endif
...
_currn->_desc1 = (_TSPChainNames) MkChainNames (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_81: root of subtree no. 1 can not be made a ChainNames node ", 0, _coordref);
_currn->_desc2 = (_TSPChainName) MkChainName (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_81: root of subtree no. 2 can not be made a ChainName node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_81;
return ( (NODEPTR) _currn);
}/* Mkrule_81 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_80: root of subtree no. 1 can not be made a ChainName node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_80;
return ( (NODEPTR) _currn);
}/* Mkrule_80 */
...
_currn->_desc1 = (_TSPAttrNames) MkAttrNames (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_78: root of subtree no. 1 can not be made a AttrNames node ", 0, _coordref);
_currn->_desc2 = (_TSPAttrName) MkAttrName (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_78: root of subtree no. 2 can not be made a AttrName node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_78;
return ( (NODEPTR) _currn);
}/* Mkrule_78 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_77: root of subtree no. 1 can not be made a AttrName node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_77;
return ( (NODEPTR) _currn);
}/* Mkrule_77 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_75: root of subtree no. 1 can not be made a AttrDefs node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_75;
return ( (NODEPTR) _currn);
}/* Mkrule_75 */
...
_currn->_desc1 = (_TSPAttrDefs) MkAttrDefs (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_73: root of subtree no. 1 can not be made a AttrDefs node ", 0, _coordref);
_currn->_desc2 = (_TSPAttrDef) MkAttrDef (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_73: root of subtree no. 2 can not be made a AttrDef node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_73;
return ( (NODEPTR) _currn);
}/* Mkrule_73 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_72: root of subtree no. 1 can not be made a AttrDef node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_72;
return ( (NODEPTR) _currn);
}/* Mkrule_72 */
...
_currn->_desc1 = (_TSPAttrDefIds) MkAttrDefIds (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_71: root of subtree no. 1 can not be made a AttrDefIds node ", 0, _coordref);
_currn->_desc2 = (_TSPAttrDefId) MkAttrDefId (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_71: root of subtree no. 2 can not be made a AttrDefId node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_71;
return ( (NODEPTR) _currn);
}/* Mkrule_71 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_70: root of subtree no. 1 can not be made a AttrDefId node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_70;
return ( (NODEPTR) _currn);
}/* Mkrule_70 */
...
_currn->_desc1 = (_TSPDefAttr) MkDefAttr (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_68: root of subtree no. 1 can not be made a DefAttr node ", 0, _coordref);
_currn->_desc2 = (_TSPLoop) MkLoop (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_68: root of subtree no. 2 can not be made a Loop node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_68;
return ( (NODEPTR) _currn);
}/* Mkrule_68 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_67: root of subtree no. 1 can not be made a Alts node ", 0, _coordref);
_currn->_desc2 = (_TSPAlt) MkAlt (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_67: root of subtree no. 2 can not be made a Alt node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_67;
return ( (NODEPTR) _currn);
}/* Mkrule_67 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_66: root of subtree no. 1 can not be made a Alt node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_66;
return ( (NODEPTR) _currn);
}/* Mkrule_66 */
...
_currn->_desc1 = (_TSPSpecs) MkSpecs (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_64: root of subtree no. 1 can not be made a Specs node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_64;
return ( (NODEPTR) _currn);
}/* Mkrule_64 */
