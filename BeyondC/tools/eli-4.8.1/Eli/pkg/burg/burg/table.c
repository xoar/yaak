char rcsid_table[] = "$Id: table.c,v 1.3 2013/11/11 09:40:11 pfahler Exp $";
...
static Item_Set restrict_is ARGS((Dimension, Item_Set));
...
static Item_Set
restrict_is(d, ts) Dimension d; Item_Set ts;
{
	DeltaCost	base;
	Item_Set	r;
	int found;
