char rcsid_plank[] = "$Id: plank.c,v 1.4 2013/12/05 21:30:11 profw Exp $";
...
static int stateCompare ARGS((const void *, const void *));
static int ruleCompare ARGS((const void *, const void *));
...
static int
stateCompare(const void *s, const void *t)
{
	return strcmp((*(Item_Set*)s)->op->name, (*(Item_Set*)t)->op->name);
}

static int
ruleCompare(const void *s, const void *t)
{
	return strcmp((*(RuleAST*)s)->lhs, (*(RuleAST*)t)->lhs);
}
