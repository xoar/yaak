static char RCSid[] = "$Id: pascalCom.c,v 1.19 2004/08/01 01:44:25 profw Exp $";
...
auxPascalComment(char *start, int length)
#else
auxPascalComment(start, length) char *start; int length;
#endif
{ register char c;
