static char RCSid[] = "$Id: auxTab.c,v 1.5 1997/09/04 18:20:11 waite Exp $";
...
/* Adjust the coordinates for a tab
 * Returns pointer to first character beyond tab.
 */

char *
#if defined(__cplusplus) || defined(__STDC__)
auxTab(char *start, int length)
#else
auxTab(start, length)
