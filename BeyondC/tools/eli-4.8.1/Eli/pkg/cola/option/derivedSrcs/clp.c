...
static opt opts[] = {
    { "-direct", BOOL , &GenerateDirect, NULL, NULL },
    { "-table", BOOL , &GenerateTable, NULL, NULL },
...
#endif
{
  ...
  fprintf (stderr, "    -direct  Allow options for direct executable parser generation.\n");
  fprintf (stderr, "    -table  Allow options for table driven parser generation.\n");
  fprintf (stderr, "  Parameters:\n");
  fprintf (stderr, "    FileName Input Option file\n");
    exit (1);
}
