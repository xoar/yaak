...
DefTableKey CmrFile = NoKey;
static int CmrFile_count = 0;
...
static opt opts[] = {
    { "-cmr", STRVAL | SPACED, &CmrFile_count, &CmrFile, NULL },
...
#endif
{
  ...
  fprintf (stderr, "    -cmr string Output file name for the COMAR data structure\n");
