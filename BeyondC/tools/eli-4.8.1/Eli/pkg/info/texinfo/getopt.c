/* $Id: getopt.c,v 1.13 2011/04/11 12:02:43 pfahler Exp $ */
/* Getopt for GNU.
...
#define bcopy(s, d, n) memcpy ((d), (s), (n))
#else
#if !defined(bcopy) && !defined(__SVR4) && !defined(__svr4__)
void bcopy ();
#endif
#endif
...
/* Do this to avoid clashes with gcc definitions of getopt */
     ...
     CONST char *optstring;
{
  ...
  if (_getopt_long_options != 0
      && (argv[optind][0] == '+'
	  || (switch_getopt_long_only && argv[optind][0] == '-'))
    )
    {
      ...
      if (pfound != 0)
	{
	 ...
	 an error.  */
      if (switch_getopt_long_only == 0 || argv[optind][0] == '+' ||
