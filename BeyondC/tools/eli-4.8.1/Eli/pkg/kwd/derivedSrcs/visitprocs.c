...
#endif
PTGNode _AVnonLitDesc__const0;
PTGNode _AVG1__const0;
int _AVlibrRef_Sym;
PTGNode _AVrest_code;
...
_VisitVarDecl()
_VisitEntry();
message(ERROR, "Keyword definition cannot specify a scanner", 0, (&( _currn->_AT_pos)));
/*SPC(21)*/
...
_AVrest_code=Canned(_AVlibrRef_Sym, (&( _currn->_AT_pos)));
/*SPC(11)*/
...
(*(_CALL_VS_((NODEPTR )) (VS1MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1);
(*(_CALL_VS_((NODEPTR )) (VS1MAP[_currn->_desc2->_prod])))((NODEPTR) _currn->_desc2);
_AVrest_code=PTGId(_currn->_ATTERM_1);
/*SPC(6)*/
...
_VisitEntry();
(*(_CALL_VS_((NODEPTR )) (VS1MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1);
PTGOutFile("filtered", _AVG1__const0);
/*SPC(29)*/
...
_VisitEntry();
(*(_CALL_VS_((NODEPTR )) (VS1MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1);
_AVnonLitDesc__const0=PTGNonLit(_AVrest_code);
/*SPC(44)*/
...
_VisitEntry();
(*(_CALL_VS_((NODEPTR )) (VS1MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1);
_AVG1__const0=_AVnonLitDesc__const0;
/*SPC(36)*/
...
(*(_CALL_VS_((NODEPTR )) (VS1MAP[_currn->_desc1->_prod])))((NODEPTR) _currn->_desc1);
(*(_CALL_VS_((NODEPTR )) (VS1MAP[_currn->_desc2->_prod])))((NODEPTR) _currn->_desc2);
_AVG1__const0=PTGSeq(_AVG1__const0, _AVnonLitDesc__const0);
/*SPC(32)*/
