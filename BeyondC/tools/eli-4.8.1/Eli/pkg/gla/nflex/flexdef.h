/* $Id: flexdef.h,v 1.14 2009/09/24 17:02:29 profw Exp $ */
/*
 ...
 * GLAflg - if true (-G), output only binary tables for GLA
...
extern FILE *skelfile, *yyin, *yyout, *temp_action_file;
...
extern char *starttime, *endtime;
extern unsigned char nmstr[MAXLINE];
...
#define reallocate_dfaacc_union(array, size) \
	(union dfaacc_union *)  reallocate_array( (void *) array, size, sizeof( union dfaacc_union ) )

#define allocate_short_array(size) \
	(short *) allocate_array( size, sizeof( short ) )

#define reallocate_short_array(array,size) \
	(short *) reallocate_array( (void *) array, size, sizeof( short ) )
