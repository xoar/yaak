...
ODIN_home=$1;shift; ODIN_gnu=$1;shift;
ODIN_atac=$1;shift; ODIN_debug=$1;shift; ODIN_prof=$1;shift;
ODIN_optimize=$1;shift; ODIN_define=$1;shift;
ODIN_flags=$1;shift;
...
if [ "$ODIN_atac" != "" ] ; then
   ...
   ATAC_CC=$compiler; export ATAC_CC
   compiler=atacCC; fi
...
if [ -f $input.atac ] ; then mv $input.atac data.atac; fi
